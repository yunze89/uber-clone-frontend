...
const PhoneLoginContainer: React.SFC<RouteComponentProps<any>> = (props) => {
  ...
  const onSubmit: React.FormEventHandler<HTMLFormElement> = (event) => {
    ...
    if (isValid) {
      //폰 로그인 mutation 호출
      phoneSignInMutation({
        variables: { phoneNumber: phone } /*update: afterSubmit*/,
    ...
    //입력값 형식 에러 시 toast메시지 발생
      ...
      toast.error(
        "Please write a valid phone number" + internationalPhoneNumber
      ); //@주의 AppContiner에서 ToastContainer를 포함시켜야 한다.
  };
